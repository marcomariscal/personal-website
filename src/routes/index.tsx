...
import { Github, Linkedin, Mail, ExternalLink, ArrowUpRight, Code2, Terminal, Database, Layers, Briefcase, GraduationCap } from 'lucide-react'
              ...
              <Card key={job.id} className="p-8 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:gap-8 md:items-start">
                  ...
                  <div className="hidden md:flex shrink-0 w-12 h-12 rounded-lg bg-white/5 items-center justify-center border border-white/10">
                    <span className="text-xl font-bold text-text-muted">{job.company.charAt(0)}</span>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-base font-medium text-[var(--color-primary)] mb-4">{job.company}</div>
        ...
        <section id="projects" className="mb-32">
          ...
          >
            {PROJECTS.map((project) => (
              <Card key={project.id} href={project.href} className="h-full flex flex-col p-8 relative overflow-hidden">
                 {/* Grid Background Pattern */}
                 <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:24px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none" />
          ...
          >
            {EDUCATION.map((edu) => (
              <Card key={edu.id} className="p-8 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:gap-8 md:items-start">
                  <div className="hidden md:flex shrink-0 w-12 h-12 rounded-lg bg-white/5 items-center justify-center border border-white/10">
                    <span className="text-xl font-bold text-text-muted">{edu.school.charAt(0)}</span>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-base font-medium text-[var(--color-primary)] mb-4">{edu.degree}</div>
              ...
              <Card key={category} className="flex flex-col gap-6 p-8 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <h3 className="text-xl font-semibold text-text-main mb-6 flex items-center gap-3">
                    ...
                    {category === 'Backend & Tools' && <Terminal className="w-5 h-5 text-text-muted" />}
                    {category}
                  </h3>
                  <div className="flex flex-wrap gap-2">
                    {skills.map((skill) => (
